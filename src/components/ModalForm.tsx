...
export function ModalForm({
  ...
  return (
    ...
    >
      <div className="neu-modal-header flex-shrink-0">
        <h2
      ...
      <form onSubmit={onSubmit} className="neu-modal-body overflow-y-auto">
        <div className="flex neu-inset p-1 rounded-xl mb-4">
          <button
            type="button"
            onClick={() => setType('cash')}
            className={`flex-1 py-2 rounded-lg text-sm font-bold transition-all ${
              type === 'cash'
                ? 'neu-pill-active text-emerald-600 dark:text-emerald-400'
          ...
          <button
            ...
            className={`flex-1 py-2 rounded-lg text-sm font-bold transition-all ${
              type === 'debt'
                ? 'neu-pill-active text-red-600 dark:text-red-400'
                : 'text-slate-500 dark:text-slate-400'
            }`}
          >
            Saída
          ...
          {isInstallment && (
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <input
                ...
                className="flex-1 neu-input rounded-lg px-2 py-1 text-xs text-slate-900 dark:text-slate-100 transition-all"
              />
            </div>
          )}
        </div>
        ...
        <div className="pt-4">
          <button
            ...
            className={`w-full py-4 rounded-2xl font-semibold transition-all active:scale-[0.98] ${
              type === 'debt' ? 'neu-btn-danger' : 'neu-btn-success'
            }`}
          >
